									...
									<div class="checkout-right">
										...
										<div class="aa-payment-method">
											<label for="cashdelivery"><input type="radio"
												...
												value="0"> Thanh toán khi nhận hàng (COD) </label>
											<label for="cashdelivery"><input type="radio"
												id="cashdelivery" name="transaction_payment" checked
												value="0"> Thanh toán bằng thẻ ngân hàng </label>	
											<label for="cashdelivery"><input type="radio"
												id="cashdelivery" name="transaction_payment" checked
												value="0"> Thanh toán qua MOMO </label>
												<input type="submit" value="ĐẶT HÀNG" class="aa-brown-btn">
										</div>
										<c:if
